        ...
        <transition name="collapse">
          <div id="section-category" v-show="open.category" class="flex flex-wrap gap-2 overflow-hidden">
            <label
              ...
              :key="c"
              class="inline-flex items-center gap-2 bg-gray-100 hover:bg-blue-100 text-gray-800 dark:bg-gray-600/40 dark:text-gray-300 dark:hover:bg-gray-500/50 rounded-lg px-2 py-1.5 cursor-pointer select-none hover:shadow-sm"
            >
            <input
              type="checkbox"
      ...
      <div class="py-3">
        <fieldset>
          ...
          <transition name="collapse">
            ...
            <label class="text-sm inline-flex items-center gap-2 select-none bg-gray-100 hover:bg-blue-100 text-gray-800 dark:bg-gray-600/40 dark:text-gray-300 dark:hover:bg-gray-500/50 rounded-lg px-2 py-1.5 cursor-pointer hover:shadow-sm">
      ...
      <div class="py-3">
        <fieldset>
          ...
          <transition name="collapse">
            ...
            <label v-for="m in materialOptions" :key="m" class="inline-flex items-center gap-2 bg-gray-100 hover:bg-blue-100 text-gray-800 dark:bg-gray-600/40 dark:text-gray-300 dark:hover:bg-gray-500/50 rounded-lg px-2 py-1.5 cursor-pointer select-none hover:shadow-sm">
