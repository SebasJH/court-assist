<template>
  <div
    class="exercise-list-item flex items-center gap-4 px-4 py-3 border-b last:border-b-0 cursor-pointer"
    role="link"
  ...
  >
    <!-- Icon -->
    <div class="exercise-icon w-10 h-10 md:w-12 md:h-12 rounded-lg flex justify-center items-center shrink-0 relative">
    ...
    <div class="flex lg:w-20 items-center justify-end gap-2 shrink-0" ref="actionsRef" @mouseenter="liftEnter" @mouseleave="liftLeave" @click.stop>
      <div class="relative">
        <div
          class="menu dropdown-button w-8 h-8 flex items-center justify-center rounded-lg transition-colors duration-200 cursor-pointer"
